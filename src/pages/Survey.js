          ...
          <Col md={8} lg={9}>
            <Card className="mb-5">
              <div aria-hidden="true" className="d-flex justify-content-between">
                <span className="h5 text-12 text-muted text-uppercase w-50 w-lg-60">Questions</span>
                <span id="res" className="h5 text-12 text-muted text-uppercase w-25 w-lg-20 text-center">Responses</span>
                <span id="rating" className="h5 text-12 text-muted text-uppercase w-25 w-lg-20 text-center">Avg Rating</span>
              </div>
              ...
              <section role="list" className="d-grid gap-4">
                <div role="listitem" className="d-flex justify-content-between">
                  ...
                  <span aria-describedby="res" className="w-25 w-lg-20 text-muted text-center fw-light text-18">271</span>
                  <span aria-labelledby="rating" className="w-25 w-lg-20 text-success text-center fw-light text-18">5</span>
                </div>
                <div role="listitem" className="d-flex justify-content-between">
                  <span className="w-50 w-lg-60">ACME motivates me to go above and beyond what I would in a similar role elsewhere</span>
                  <span aria-describedby="res" className="w-25 w-lg-20 text-muted text-center fw-light text-18">270</span>
                ...
                <div role="listitem" className="d-flex justify-content-between">
                  ...
                  <span aria-describedby="res" className="w-25 w-lg-20 text-muted fw-light text-center text-18">269</span>
                ...
                <div role="listitem" className="d-flex justify-content-between">
                  ...
                  <span aria-describedby="res" className="w-25 w-lg-20 text-muted text-center fw-light text-18">271</span>
                  <span aria-labelledby="rating" className="w-25 w-lg-20 text-danger text-center fw-light text-18">2.25</span>
                </div>
              </section>
