            ...
            <Card className="mb-5">
              ...
              <section role="list" className="d-grid gap-4">
                <div role="listitem" className="d-flex justify-content-between">
                  ...
                  <span aria-labelledby="res" className="w-25 w-lg-20 text-center fw-light text-18">271</span>
                ...
                <div role="listitem" className="d-flex justify-content-between">
                  ...
                  <span aria-labelledby="res" className="w-25 w-lg-20 text-center fw-light text-18">270</span>
                ...
                <div role="listitem" className="d-flex justify-content-between">
                  ...
                  <span aria-labelledby="res" className="w-25 w-lg-20 fw-light text-center text-18">269</span>
